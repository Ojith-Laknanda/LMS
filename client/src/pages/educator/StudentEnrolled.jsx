...
const StudentEnrolled = () => {
  // make a state variable for store the data from the backend for the students
  ...
  return enrolledStudents ? (
    <div className="min-h-screen flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pb-0">
      <div className=" flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gray-500/20"> {/* here we will display the enrolled students inside a table */}
